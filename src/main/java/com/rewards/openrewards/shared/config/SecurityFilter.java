package com.rewards.openrewards.shared.config;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException, ServletException, IOException {
        ...
        if(token != null){
            //TODO: CACHE
            AuthCredentials login = tokenGateway.validateToken(token);
    ...
    private UserDetails getUser(final AuthCredentials authCredentials) {
        return AuthCredentials.builder().email(authCredentials.getEmail()).build();
    }
